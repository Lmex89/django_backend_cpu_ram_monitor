...
class MemGrepper:
    ...
    def get_all_indexs_(self, lines):
        ...
        index_used = self.get_index_string_in_line(
            lines, string_look=self.enum_const.USED.value
        )
        index_total = self.get_index_string_in_line(
            lines, string_look=self.enum_const.TOTAL.value
        )
        index_aval = self.get_index_string_in_line(
            lines, string_look=self.enum_const.AVAILABLE.value
        )
